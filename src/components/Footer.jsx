    ...
    return <footer className='bg-[var(--secondary-bg-color)] ' >
        <Container classes='flex justify-between gap-4 flex-col md:flex-row pb-3 border-b-2 border-[var(--border-color)]  p-4' >
            <div  >
                ...
                <p className='mt-2' > <i className="fa-solid fa-envelope mr-3"></i> loaialshujaa3@gmail.com </p>
            ...
            <div>
                ...
                <div className="social flex gap-2 mt-3">
                    ...
                    <Social link="https://www.linkedin.com/in/loai-alshujaa" aria='visit me Linkedin account' icon={ <i className="fa-brands fa-linkedin-in"></i>} ></Social>
