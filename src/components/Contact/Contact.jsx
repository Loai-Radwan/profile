...
export default function Contact() {
    ...
    return (
        <Container >
            <Title >Contact Me</Title> <form className="flex align-center flex-col" action="https://formsubmit.co/loairalshujaa@gmail.com" method="POST">
            ...
            <input type="hidden" name="_subject" value={`New submission! from ${nameInput.current.value}`} />


                <Input ref={nameInput} placeholder='Enter Your Name' type='text' name='name' />
